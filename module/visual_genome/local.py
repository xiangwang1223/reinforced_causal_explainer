...
import gc
import json
import module.visual_genome.utils as utils
from module.visual_genome.models import (Image, Object, Attribute, Relationship,
                                  Graph, Synset)
...
def get_scene_graph(image_id, images='data/',
    ...
    data = json.load(open(osp.join(image_data_dir, fname), 'r'))
